...
def prepare_input(credit_score, location, gender, age, tenure, balance,
    ...
    input_dict = {
        ...
        'Goegraphy_France': 1 if location == 'France' else 0,
        'Goegraphy_Germany': 1 if location == 'Germany' else 0,
        'Goegraphy_Spain': 1 if location == 'Spain' else 0,
...
def explain_prediction(probability, input_dict, surname):
    ...
    Here is Customer's Information:
    {input_dict}
